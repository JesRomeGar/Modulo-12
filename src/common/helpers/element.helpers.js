...
/*Nota: Esta funcion recoge la informacion del input (el input id que hayas puesto en el html)
 cuando teclea el usuario y ejecuta la funcion que quieras(segundo parametro)*/
...
/*Esta funcion escribe un mensaje de error en el html si la validacion del campo rellenado 
no ha funcionado */
